...
## Debug
Can be enabled by adding `--enable-debug` to `lool_configure_opts''` in officeonline-install.cfg before compiling. Change filesystem allow="false" to "true" in /opt/online/loolwsd.xml
